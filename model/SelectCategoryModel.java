...
public class SelectCategoryModel implements Parcelable {
...
//	private ArrayList<ImageGallerySubcategoryModel> mSubcategories;
	...
	protected SelectCategoryModel(Parcel in) {
		mId = in.readLong();
		mUrl = in.readString();
...
//		}
	...
	public static final Creator<SelectCategoryModel> CREATOR = new Creator<SelectCategoryModel>() {
		@Override
		public SelectCategoryModel createFromParcel(Parcel in) {
			return new SelectCategoryModel(in);
		}

		@Override
		public SelectCategoryModel[] newArray(int size) {
			return new SelectCategoryModel[size];
		}
	};
}